...
def write_file(results: list()):
    header = [ "Model Name", "material name of last model", "number of CEM files", "CEM version major", "CEM version minor" ]
    ...
    if f.endswith(".cem"):
        ...
        with open(f, "rb") as cemfile:
            if cemfile.read(4) != cem_magic:
                ...
                result.append( [ f, material_name, num_cem, version_maj, version_min ] )
